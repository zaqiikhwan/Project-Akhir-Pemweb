<div>
    <h2 class="mb-10 text-3xl text-primary-500 font-semibold text-center">WILAYAH DESA PALENGAAN LAOK</h2>
    ...
    <section class="card flex p-8 pl-12">
        <ol class="basis-1/2 text-xl flex flex-col gap-1">
            ...
            <li>Banyupelle</li>
            <li>Kacok</li>
            <li>Larangan Badung</li>
            <li>Palenggaan Laok</li>
         </ol>
         <ol start="7" class="basis-1/2 text-xl flex flex-col gap-1">
            <li>Palenggaan Dajah</li>
            <li>Pana'an</li>
            <li>Potoan Laok</li>
            <li>Potoan Dajah</li>
            <li>Rek Kerrek</li>
