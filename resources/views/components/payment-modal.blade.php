<div
    ...
    <section class="p-8 w-2/3 relative rounded-md modal-content bg-primary-500">
        ...
        <h2 class="text-white font-bold mb-8 text-center">Formulir Pembeli</h2>
        <form action="" class="flex">
            <section class="flex flex-col gap-8 basis-3/5 pr-8 border-r-2">
                <span>
                    <label for="nama" class="text-white block">Nama</label>
                    <input 
                        type="text" 
                        name="nama" 
                        id="nama"
                ...
                <span>
                    <label for="alamat" class="text-white block">Alamat</label>
                    <input 
                        type="text"
                        name="alamat"
                        id="alamat"
                ...
                <span>
                    <label for="telepon" class="text-white block">Nomor Telepon</label>
                    <input 
                        type="text"
                        name="telepon"
                        id="telepon"
